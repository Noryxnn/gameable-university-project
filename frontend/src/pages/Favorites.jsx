      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <FaHeart className="w-10 h-10 text-pink-500 fill-pink-500 animate-pulse" />
        ...
        {games.length === 0 ? (
          ...
          <>
            <p className="text-white/70 mb-6 text-lg font-semibold bg-black/40 backdrop-blur-md px-6 py-3 rounded-2xl inline-block border border-purple-500/30">
