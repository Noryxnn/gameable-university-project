    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-pink-900 py-8 sm:py-12 md:py-20">
      <div className="container mx-auto px-3 sm:px-4 max-w-6xl">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-black bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent flex items-center gap-2 sm:gap-3">
            <FaCog className="text-purple-400 text-xl sm:text-2xl md:text-3xl" />
            Settings
          </h1>
          <p className="text-gray-400 mt-1 sm:mt-2 text-sm sm:text-base">Manage your account and accessibility preferences</p>
        </div>

        {/* Profile Box */}
        <div className="bg-black/60 backdrop-blur-xl border-2 border-purple-500/50 rounded-lg p-4 sm:p-6 mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="relative flex-shrink-0">
                {getImageSrc(user?.profilePicture) ? (
                  <img
                    ...
                    alt="Profile"
                    className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full object-cover border-4 border-purple-400/50"
                    onError={(e) => {
                ...
                <div
                  className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center border-4 border-purple-400/50 ${
              ...
              <div className="min-w-0">
                <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white truncate">{user?.username || "User"}</h2>
                <p className="text-gray-400 text-sm sm:text-base truncate">{user?.email || ""}</p>
              </div>
            </div>
            <button
              onClick={() => navigate("/profile")}
              className="w-full sm:w-auto flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-colors text-sm sm:text-base"
            >
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6">Accessibility Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {/* Color Blind Mode */}
            <div className="bg-black/60 backdrop-blur-xl border-2 border-purple-500/50 rounded-lg p-4 sm:p-6">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <FaEye className="text-purple-400 text-lg sm:text-xl" />
                <h3 className="text-lg sm:text-xl font-bold text-white">Color Blind Mode</h3>
              </div>
            ...
            <div className="bg-black/60 backdrop-blur-xl border-2 border-purple-500/50 rounded-lg p-4 sm:p-6">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <FaVolumeUp className="text-purple-400 text-lg sm:text-xl" />
                <h3 className="text-lg sm:text-xl font-bold text-white">Text-to-Speech</h3>
              </div>
              <p className="text-gray-400 text-xs sm:text-sm mb-3 sm:mb-4">
